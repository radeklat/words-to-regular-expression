...
tree (also known as trie or radix tree). This struture is not intended to be
...
* Colapsing of repeated sequences. For example _"subsubsection"_ will get
  transformed into _(?:sub){2}section_. This unfortunately does not produce a
...
* Automatic escaping of regular expressions. For example _"test"_ and _"te*st"_  
  will become _te(?:st|\*st)_.
